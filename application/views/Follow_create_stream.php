...
<form method="post" accept-charset="utf-8" action="http://127.0.0.1/picpic/follow/create">
  <div class="form-group">
    <label for="stream-name">Stream name</label>
    <input type="text" class="form-control" name="stream-name" placeholder='input your board name here'>
  </div>
