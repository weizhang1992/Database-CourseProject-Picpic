...
<div id="navbar">
 <ul class="nav nav-pills nav-justified">
  ...
  <li role="presentation" class="active"><a href="http://127.0.0.1/picpic/account/like">like</a></li>
</ul>
</div>
<br>
 ...
 <div id="pinboard">
     ...
     <form method="post" accept-charset="utf-8" action=<?php echo "http://127.0.0.1/picpic/follow/followboard/".$boarditem['boardid']?>>
      <div class="buttons" id="followbutton">
            <input type="submit" class="btn btn-warning" name="create" value=follow>
      </div>
     </form>
